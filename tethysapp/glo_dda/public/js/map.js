...
var LIBRARY_OBJECT = (function() {
    ...
    init_map = function(){
        ...
        var handleDownloadLayers = function(e) {
            ...
            //     var polygons_csv = '/apps/glo-dda/api/download-polygons-csv/';
            //     var points_csv = '/apps/glo-dda/api/download-points-csv/';
                            ...
                            if(Object.keys(meta_dict).length>0){
                                $.each(meta_dict, function (key, val) {
                                    if(key.indexOf('file') !== -1){
                                        var get_req = '/apps/glo-dda/get-meta-file/?file='+val;
    ...
    get_db_file = function(){
        ...
        if(layer_type==='layer_csv'){
            ...
            var req_url = '/apps/glo-dda/api/download-layer-csv/?layer_type='+csv_layer_type+'&layer_name='+layer_name;
            window.open(req_url);
        }else{
            var xhr = ajax_update_database("download-layers", {});
