...
var LIBRARY_OBJECT = (function() {
    ...
    view_point = function(e, cell){
        ...
        var sld_string = '<StyledLayerDescriptor version="1.0.0"><NamedLayer><Name>glo_dda:points</Name><UserStyle><FeatureTypeStyle>\
                        <Rule>\
                        <PointSymbolizer>\
                        <Graphic>\
                        <Mark>\
        ...
        wms_source = new ol.source.ImageWMS({
            url: gs_wms_url,
            params: {'LAYERS': 'glo_dda:points', 'SLD_BODY':sld_string,
                'FeatureID': point_id},
            serverType: 'geoserver',
            crossOrigin: 'Anonymous'
        });
